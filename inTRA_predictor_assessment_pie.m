...
%         all_pred_campmean = [all_pred_campmean; pred_campmean];
    ...
    figure('Position',[804 311 1117 566]); %[92 148 1325 650])
...
%     nsp = subplot(10,1,1:5);
    ...
    cbar = colorbar;
    cbar.Ticks = .1:.2:.9;
    cbar.TickLabels = {'ER', 'NH', 'LAF', 'N_d', 'N_a'};
    
    bubblepie(1:31,zeros(31,1)-.02,ones(31,1),double(feat_comb_bin(:,2:end)))
    colormap(lines(5))
...
saveas(gcf, ['plots/abstract/(pie) why i chose certain predictors ', camp '.png'])
